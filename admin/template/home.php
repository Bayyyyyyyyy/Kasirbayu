...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-blue text-white" style="background: rgb(0,212,255);
            background: linear-gradient(90deg, rgba(0,212,255,0.5606617647058824) 25%, rgba(84,98,171,0.6278886554621849) 75%);">
